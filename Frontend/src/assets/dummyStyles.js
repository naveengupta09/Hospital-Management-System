...
export const navbarStyles = {
  navbarBorder: "h-px w-full bg-gradient-to-r from-transparent via-emerald-300/60 to-transparent",
  navbarContainer: "sticky top-0 z-50 backdrop-blur-md bg-white/70 border-b border-emerald-100/60 transition-transform duration-300",
  navbarVisible: "translate-y-0",
  navbarHidden: "-translate-y-full",
  contentWrapper: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8",
  flexContainer: "flex items-center justify-between gap-4 py-4",

  logoLink: "flex items-center gap-3",
  logoContainer: "relative",
  logoImageWrapper: "h-11 w-11 rounded-full bg-emerald-100 ring-2 ring-white flex items-center justify-center shadow-sm",
  logoImage: "h-9 w-9 rounded-full object-cover",
  logoTextContainer: "leading-tight",
  logoTitle: "text-lg sm:text-xl font-semibold text-emerald-900 tracking-tight",
  logoSubtitle: "text-xs text-emerald-600",

  desktopNav: "hidden lg:flex",
  navItemsContainer: "flex items-center gap-1 rounded-full bg-white/80 px-2 py-1 shadow-sm ring-1 ring-emerald-100",
  navItem: "px-3 py-2 text-sm font-medium rounded-full transition-colors",
  navItemActive: "bg-emerald-600 text-white shadow",
  navItemInActive: "text-emerald-700 hover:bg-emerald-50",

  rightSideContainer: "flex items-center gap-2 sm:gap-3",
  doctorAdminButton: "hidden sm:inline-flex items-center gap-2 rounded-full bg-emerald-50 text-emerald-700 px-3 py-2 text-sm font-medium ring-1 ring-emerald-100 hover:bg-emerald-100 transition",
  doctorAdminIcon: "h-4 w-4",
  doctorAdminText: "hidden md:inline",
  loginButton: "inline-flex items-center gap-2 rounded-full bg-emerald-600 text-white px-3 py-2 text-sm font-medium shadow hover:bg-emerald-700 transition",
  loginIcon: "h-4 w-4",

  mobileToggle: "lg:hidden inline-flex items-center justify-center h-9 w-9 rounded-full bg-white shadow ring-1 ring-emerald-100",
  toggleIcon: "h-5 w-5 text-emerald-700",

  mobileMenu: "lg:hidden mt-3 rounded-2xl bg-white/95 shadow-lg ring-1 ring-emerald-100 p-3 space-y-2",
  mobileMenuItem: "block px-3 py-2 text-sm font-medium rounded-xl transition",
  mobileMenuItemActive: "bg-emerald-600 text-white",
  mobileMenuItemInactive: "text-emerald-700 hover:bg-emerald-50",
  mobileDoctorAdminButton: "block w-full text-center rounded-xl bg-emerald-50 text-emerald-700 px-3 py-2 text-sm font-medium ring-1 ring-emerald-100",
  mobileLoginContainer: "pt-2",
  mobileLoginButton: "w-full rounded-xl bg-emerald-600 text-white px-3 py-2 text-sm font-medium",

  animationStyles: `
    @keyframes navFloat {
      0% { box-shadow: 0 0 0 rgba(0, 0, 0, 0); }
      100% { box-shadow: 0 8px 24px rgba(16, 185, 129, 0.15); }
    }
  `,
};
