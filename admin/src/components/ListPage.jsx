...
//HELPER FUNCTION
// this function will give you output as DD-MM_YYYY;
    ...
    <div className={doctorListStyles.container}>
      ...
      <main className={doctorListStyles.gridContainer}>
        ...
        {displayed.map((doc) => {
          ...
          const schedulesMap = buildScheduleMap(doc.schedule || {});
          const sortedDates = getSortedScheduleDates(schedulesMap);
                ...
                <div className={doctorListStyles.doctorInfoContainer}>
                  ...
                  <div className={doctorListStyles.statsContainer}>
                    ...
                    <div className={doctorListStyles.statsValue}>
                      <Users size={14} /> {doc.patientCount}
                    </div>
        ...
        {filtered.length > 6 && (
          <div className={doctorListStyles.showMoreContainer}>
            ...
            >
              {showAll
                ? "Show Less"
                : `Show More (${filtered.length - displayed.length})`}
            </button>
          </div>
        )}
      </main>
